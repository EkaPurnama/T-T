            ...
            $.ajax({
                ...
                success: function(data){
                    $.each(data, function(i,item){
                        ...
                        $('select#id_').attr('disabled', 'disabled');
                        $('form#illuminati').attr('action','post/spd/edit/'+ item.id_spd);
                        $.ajax({
                            url: "ajax/nama_pemangku/" + item.nip,
                            cache: false,
                            success: function(hata){
                                $('div#nama_petugas').append(item.nama_pemangku);
                            }
                        });
                    });
                }
...
$('#dialog_detail').on('show.bs.modal', function (e){
    ...
    $(this).find('button#ekspor').attr('onclick', 'location.href="ekspor/data/rincian_biaya/'+$kodespd+'"');
    $(this).find('button#ekspor_pengikut').attr('onclick', 'location.href="ekspor/data/pengikut/'+$kodespd+'"');
    ...
    $.ajax({
        ...
        success: function(data){
            for (var s = 0; s < data.length; s++) {
                ...
                $.ajax({
                    url: "ajax/detail/rincian/" + data[s],
                    cache: false,
                    success: function(mata){
                        $.each(mata, function(i,item){
